...
(function () {
  ...
  var CONFIG = {
    ...
    // folosește și nu mai deschide clientul de e-mail.
  ...
  function initContactForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // fără backend: deschidem clientul de e-mail cu mesajul pregătit
      var subject = 'Cerere ofertă — ' + (data.lucrare || 'lucrare interioară');
      window.location.href = 'mailto:' + CONFIG.email +
        '?subject=' + encodeURIComponent(subject) +
        '&body=' + encodeURIComponent(buildBody(data));

      show('Am pregătit mesajul în aplicația ta de e-mail. Dacă nu s-a deschis, scrie-ne la ' + CONFIG.email + '.', 'ok');
    });
